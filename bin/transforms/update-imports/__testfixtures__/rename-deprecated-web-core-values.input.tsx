...
export default function App() {
    ...
    activeParticpants;
    useEffect(() => {
        console.log(maxScreenShareCount);
        console.log(permissions.maxScreenShareCount);
        console.log(self.permissions.maxScreenShareCount);
        console.log(m.self.permissions.maxScreenShareCount);
        console.log(meeting.self.permissions.maxScreenShareCount);
    }, []);
